...
import {Editor, EditorProps, TagData, User} from './editor/Editor';
...
const Template: Story<EditorProps> = (args) => <Editor tags={args.tags} users={args.users} />;
